...
@section('content')
<div class="p-6">
    <h1 class="text-2xl font-bold mb-6">Tambah Tahun Pelajaran</h1>
        ...
        <form method="POST" action="{{ route('tahun-pelajaran.store') }}">
            ...
            <div class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <input type="text" name="nama_tahun" value="{{ old('nama_tahun') }}" placeholder="Contoh: 2025/2026" required class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm">
                </div>
                <div>
