        ...
        <form method="POST" action="{{ route('mata-pelajaran.store') }}">
            ...
            <div class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <input type="text" name="nama_mapel" value="{{ old('nama_mapel') }}" required class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm {{ $errors->has('nama_mapel') ? 'border-red-500' : '' }}">
                ...
                <div>
                    ...
                    <input type="text" name="kode_mapel" value="{{ old('kode_mapel') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm {{ $errors->has('kode_mapel') ? 'border-red-500' : '' }}">
                ...
                <div>
                    ...
                    <input type="number" name="kkm" value="{{ old('kkm', 75) }}" min="0" max="100" required class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm {{ $errors->has('kkm') ? 'border-red-500' : '' }}">
                ...
                <div>
                    ...
                    <input type="text" name="kelompok" value="{{ old('kelompok') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm">
                </div>
                <div>
